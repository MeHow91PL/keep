...
export default class NoteInput extends Component {
    ...
    addNote = () => {
        const { nowaNotka, dodajNotatke, zmienTekst, zwinNotke } = this.props;
        if (nowaNotka.tekst.trim() !== "") {
            nowaNotka.createDate = new Date();
            dodajNotatke(nowaNotka);
            zmienTekst({ tytul: '', tekst: '' });
            this.tekstRef.current.innerHTML = '';
        }
        zwinNotke();
    }
    ...
    handleInputChange(e) {
        ...
        const value = target.tagName === 'INPUT' ? target.value : target.innerHTML;
        const name = target.dataset.name;
        this.props.zmienTekst({
            [name]: value
        })
    }

    render() {
        const { nowaNotka, dodajNotatke, zmienTekst, rozwinNotke, zwinNotke } = this.props
        return (
            <div>
                <div ref={this.inputRef}
                    className={`dodajNotatke-input ${nowaNotka.aktywny ? 'aktywny' : ''}`}>
                    ...
                    <div className="zwinietyInput">
                        <div className="tekst">
                            ...
                            <div
                                ...
                                onFocus={() => {
                                    if (!nowaNotka.aktywny) rozwinNotke();
                                }}
                        ...
                        <div className="buttons-cont zwiniete">
                            ...
                            <div className="NotatkaNowaLista btn" data-title='Utwórz listę'>
                                <svg
                            ...
                            <div className="NotatkaFoto btn" data-title='Dodaj zdjęcie'>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="100%"
                                    height="100%"
                            ...
                            <div className="NotatkaRys btn" data-title='Dodaj rysunek'>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 48 48"
                                    fill="#000000">
                    ...
                    <div className="rozwiniete">
                        <div className="buttons-cont">
                            <div className="przypomnij btn" data-title='To jeszcze nie działa :)' >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 48 48"
                                    fill="#000000">
                            ...
                            <div className="wspolpracownik btn" data-title='To jeszcze nie działa :)'>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 18 18"
                                    fill="#000000">
                            ...
                            <div className="zmienKolor btn" data-title='To jeszcze nie działa :)'>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 48 48"
                                    fill="#000000">
                            ...
                            <div className="dodajObraz btn" data-title='To jeszcze nie działa :)'>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 48 48"
                                    fill="#000000">
                            ...
                            <div className="archiwizuj btn" data-title='To jeszcze nie działa :)'>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 48 48"
                                    fill="#000000">
                            ...
                            <div className="wiecej btn" data-title='To jeszcze nie działa :)'>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    height="100%"
                                    width="100%"
                            ...
                            <div className="cofnij btn" data-title='To jeszcze nie działa :)'>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 48 48"
                                    fill="#000000">
                            ...
                            <div className="ponow btn" data-title='To jeszcze nie działa :)'>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 48 48"
                                    fill="#000000"
                ...
                {/*
                <div className='noteInputBlur' 
                onClick={() => { this.addNote() }}
                style={{display: `${nowaNotka.aktywny?'block':'none'}`}}
                >
                </div>
                */}
            </div>
