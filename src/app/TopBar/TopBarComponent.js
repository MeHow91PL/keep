...
const TopBar = ({ toggleSidebar, previousSite }) => {
    return (
        <div className={`top-bar`} >
                ...
                <div className="btn nav-btn back" onClick={previousSite}  data-title='Wstecz'>
            ...
            <SearchInput />
            <div className="btn odswiez" data-title='Odśwież'>
                <svg
            ...
            <div className="btn widok" data-title='Zmień widok'>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20">
            ...
            <div className="btn profil" data-title='Profil'>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
